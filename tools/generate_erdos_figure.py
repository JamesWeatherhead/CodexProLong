...
<text x="76" y="250" fill="#f7f3ff" font-size="78" font-weight="800" font-family="ui-monospace, SFMono-Regular, Menlo, Consolas, monospace">5 DOMAIN-VALID #1s</text>
<text x="76" y="344" fill="#55d9ff" font-size="39" font-weight="600" font-family="ui-monospace, SFMono-Regular, Menlo, Consolas, monospace">Persistent memory. Self-written solvers.</text>
<text x="76" y="407" fill="#56f3bf" font-size="39" font-weight="600" font-family="ui-monospace, SFMono-Regular, Menlo, Consolas, monospace">Public receipts.</text>
<text x="76" y="553" fill="#c7c1db" font-size="25" font-family="ui-monospace, SFMono-Regular, Menlo, Consolas, monospace">Featured: a problem posed by Erdős in 1955</text>
</svg>
"""
