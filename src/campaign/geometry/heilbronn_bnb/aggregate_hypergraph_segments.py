#!/usr/bin/env python3
"""Audit and merge disjoint side-root intervals from hypergraph DFS runs."""
...
def main() -> int:
    ...
    for path in args.summaries:
        ...
        start = int(record.get("start_root_set", 0))
        completed = int(record["completed_root_sets"])
        ...
        total_roots_set.add(int(record["root_set_count"]))
    ...
    output = {
        "mode": "audited union of exact side-root DFS intervals",
